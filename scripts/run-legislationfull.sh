...
saxonb-xslt -ext:on ../data/input/acts-and-regs/Legis.xml ../xslt/acts-and-regs/legisfull2archi-snippet.xsl uuid=$UUID outdir=$OutDir layer=$Layer element=$Element
